...
test('Login Actitime Application', async({page})=>{
    ...
    await page.goto("http://localhost:8080/login.do")
 //   await page.waitForTimeout(3000)
    ...
    await expect(page).toHaveURL("http://localhost:8080/user/submit_tt.do")
 ...
 //   await page.waitForTimeout(4000)
    ...
    await expect(page).toHaveURL("http://localhost:8080/login.do")
